...
import { ArrowRight, Play, RotateCcw, Award } from 'lucide-react';
...
export const InterviewHistoryTable = ({ interviews = [] }) => {
  ...
  return (
    <div className="bg-slate-900/80 border border-slate-800 rounded-3xl overflow-hidden backdrop-blur-xl shadow-xl">
            ...
            <div key={id} className="p-4 space-y-3">
              <div className="flex items-start justify-between gap-2">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-0.5">{type} • {difficulty}</p>
                </div>
              ...
              <div className="flex items-center justify-between text-xs text-slate-400 font-mono pt-1">
                ...
                {isCompleted && score !== null ? (
                  ...
                  <span>{completedQuestions}/{totalQuestions} Qs</span>
                )}
              </div>
      ...
      {/* Desktop Table View (Visible sm+ breakpoint) */}
